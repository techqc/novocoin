// Copyright (c) 2012-2016, The CryptoNote developers, The Bytecoin developers, The Novocoincoin developers
//
// This file is part of Novocoincoin.
//
// Novocoincoin is free software: you can redistribute it and/or modify
// it under the terms of the GNU Lesser General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// Novocoincoin is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
// GNU Lesser General Public License for more details.
//
// You should have received a copy of the GNU Lesser General Public License
// along with Novocoincoin.  If not, see <http://www.gnu.org/licenses/>.
...
WalletTransactionSender::WalletTransactionSender(const Currency& currency, WalletUserTransactionsCache& transactionsCache, AccountKeys keys, ITransfersContainer& transfersContainer) :
  ...
  m_upperTransactionSizeLimit(parameters::CRYPTONOTE_MAX_TX_SIZE - m_currency.minerTxBlobReservedSize()) {
}
