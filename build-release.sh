...
function usage()
{
    ...
    echo "and generates the checksum files of the Novocoin tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/techqc/novocoin.git"
CLONE_DIR="$BUILD_DIRECTORY/novocoin-buildall"
TARGET_DIR="$BUILD_DIRECTORY/novocoin-releases"
DYNAMIC_RELEASE="novocoin-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="novocoin-${TAG_VERSION}-linux-staticboost-CLI"
